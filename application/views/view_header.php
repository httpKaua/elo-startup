    ...
    <nav class="u-align-right u-menu u-menu-one-level u-offcanvas u-menu-1">
      ...
      <div class="u-custom-menu u-nav-container">
        <ul class="u-custom-font u-nav u-spacing-20 u-unstyled u-nav-1">
          ...
          <li class="u-nav-item"><a class="u-border-active-palette-1-base u-border-hover-palette-1-base u-button-style u-nav-link u-text-active-palette-5-light-3 u-text-body-alt-color u-text-hover-grey-15" href="<?php echo base_url("#sec-a4c9")?>" style="padding: 18px 28px;">Sobre</a>
          </li>
          <li class="u-nav-item"><a class="u-border-active-palette-1-base u-border-hover-palette-1-base u-button-style u-nav-link u-text-active-palette-5-light-3 u-text-body-alt-color u-text-hover-grey-15" href="<?php echo base_url("#sec-4848")?>" style="padding: 18px 28px;">Contato</a>
          </li>
          <?php if (!isset($_SESSION["usuario"])) { ?>
            <li class="u-nav-item"><a class="u-button-style u-nav-link" href="<?php echo base_url('/login') ?>">Login</a>
            </li>
          <?php } else { ?>
            <li class="u-nav-item">Logado</a>
            </li>
          <?php } ?>
        </ul>
      </div>
        ...
        <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
          <div class="u-inner-container-layout u-sidenav-overflow">
            ...
            <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
              ...
              <li class="u-nav-item"><a class="u-button-style u-nav-link" href="<?php echo base_url("#sec-a4c9")?>">Sobre</a>
              </li>
              <li class="u-nav-item"><a class="u-button-style u-nav-link" href="<?php echo base_url("#sec-4848")?>">Contato</a>
              </li>
              <?php if (!isset($_SESSION["usuario"])) { ?>
                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="<?php echo base_url('/login') ?>">Login</a>
                </li>
